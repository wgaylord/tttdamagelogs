local monthnames = {TTTLogTranslate(GetDMGLogLang, "January"), TTTLogTranslate(GetDMGLogLang, "February"), TTTLogTranslate(GetDMGLogLang, "March"), TTTLogTranslate(GetDMGLogLang, "April"), TTTLogTranslate(GetDMGLogLang, "May"), TTTLogTranslate(GetDMGLogLang, "June"), TTTLogTranslate(GetDMGLogLang, "July"), TTTLogTranslate(GetDMGLogLang, "August"), TTTLogTranslate(GetDMGLogLang, "September"), TTTLogTranslate(GetDMGLogLang, "October"), TTTLogTranslate(GetDMGLogLang, "November"), TTTLogTranslate(GetDMGLogLang, "December")}
...
function Damagelog:DrawOldLogs()
    ...
    self.DateChoice.OnNodeSelected = function(panel, selected)
        if selected.rounds then
            ...
            for _, v in ipairs(selected.rounds) do
                ...
                end -- Hack way to stupid duplicate rounds
            end
        end
    end
    ...
    self.LoadLogs.DoClick = function(panel)
        if panel.MoveTop or panel.MoveBot then
            return
        end
