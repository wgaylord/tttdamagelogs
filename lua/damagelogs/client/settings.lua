...
CreateClientConVar("ttt_dmglogs_shotlogsondamagetab", "0", FCVAR_ARCHIVE)
...
hook.Add("TTTSettingsTabs", "DamagelogsTTTSettingsTab", function(dtabs)
    ...
    dgui:CheckBox(TTTLogTranslate(GetDMGLogLang, "ShotLogsDamageTab"), "ttt_dmglogs_shotlogsondamagetab")
